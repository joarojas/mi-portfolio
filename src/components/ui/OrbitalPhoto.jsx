// ============================================================
//  components/ui/OrbitalPhoto.jsx
//  Foto de perfil con anillos orbitales animados.
// ============================================================
import { ME } from "../../data";
...
export function OrbitalPhoto() {
  return (
    <div className="hero-orbital-container">
      ...
      {ORBITERS.map((o, i) => (
        <div key={i} style={{ position:"absolute", width:"100%", height:"100%", display:"flex", alignItems:"center", justifyContent:"center" }}>
          <div style={{ animation: o.anim, width: o.sz + 12, height: o.sz + 12, borderRadius:"50%", background: o.color + "22", border:`1px solid ${o.color}66`, display:"flex", alignItems:"center", justifyContent:"center" }}>
            <i className={o.icon} style={{ fontSize: o.sz * 0.7 }} />
          </div>
        </div>
      ))}
      ...
      {CORNERS.map(([t, l, vt, hl], i) => (
        <div key={i} className="aesthetic-corner" style={{
          position: "absolute",
          top:    t  !== null ? t    : undefined,
          left:   l  !== null ? l    : undefined,
          bottom: t  === null ? -10  : undefined,
          right:  l  === null ? -10  : undefined,
          width: 18, height: 18, zIndex: 5,
          borderTop:    vt === "top"    ? "2px solid #2de2e6" : "none",
          borderBottom: vt === "bottom" ? "2px solid #2de2e6" : "none",
          borderLeft:   hl === "left"   ? "2px solid #2de2e6" : "none",
          borderRight:  hl === "right"  ? "2px solid #2de2e6" : "none",
        }} />
      ))}
    </div>
  );
