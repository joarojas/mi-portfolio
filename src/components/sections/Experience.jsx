...
export function Experience({ t, lang }) {
  return (
    <section id="experience" style={{ background:"#050508" }}>
      <div className="section-container">
        <Reveal><SectionLabel n={4} text={t.experience.label} /></Reveal>
        <Reveal><SectionTitle line1={t.experience.title1} line2={t.experience.title2} accentColor="#2de2e6" /></Reveal>
